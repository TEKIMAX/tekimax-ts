...
var allowedToolChoiceSchema = import_zod3.z.object({
  ...
  tools: import_zod3.z.array(
    import_zod3.z.lazy(() => functionToolChoiceSchema),
  ),
...
var specificFunctionParamSchema = import_zod4.z.object({
  ...
  name: import_zod4.z
    .string()
    .describe('The name of the function tool to call.'),
})

// src/gen/zod/specificToolChoiceParamSchema.ts
var import_zod5 = require('zod')
var specificToolChoiceParamSchema = import_zod5.z.lazy(
...
var allowedToolsParamSchema = import_zod6.z.object({
  ...
  tools: import_zod6.z
    .array(import_zod6.z.lazy(() => specificToolChoiceParamSchema))
    .min(1)
    .max(128)
    .describe('The list of tools that are permitted for this request.'),
  mode: import_zod6.z.optional(
    import_zod6.z
      .lazy(() => toolChoiceValueEnumSchema)
      .and(import_zod6.z.any()),
  ),
})

// src/gen/zod/urlCitationBodySchema.ts
var import_zod7 = require('zod')
var urlCitationBodySchema = import_zod7.z
  .object({
    type: import_zod7.z
      .enum(['url_citation'])
    ...
    start_index: import_zod7.z
      .number()
      .int()
      .describe(
        'The index of the first character of the URL citation in the message.',
      ),
    end_index: import_zod7.z
      .number()
      .int()
      .describe(
...
var annotationSchema = import_zod8.z
...
var outputTextContentParamSchema = import_zod10.z.object({
  ...
  annotations: import_zod10.z.optional(
    import_zod10.z
      .array(import_zod10.z.lazy(() => urlCitationParamSchema))
...
var assistantMessageItemParamSchema = import_zod12.z.object({
  id: import_zod12.z.optional(
    import_zod12.z.union([import_zod12.z.string(), import_zod12.z.null()]),
  ),
  type: import_zod12.z
    .enum(['message'])
    .default('message')
  ...
  status: import_zod12.z.optional(
    import_zod12.z.union([import_zod12.z.string(), import_zod12.z.null()]),
  ),
})
...
var includeEnumSchema = import_zod13.z.enum([
...
var functionCallStatusSchema = import_zod14.z.enum([
  'in_progress',
  'completed',
  'incomplete',
])
...
var functionCallItemParamSchema = import_zod15.z.object({
  id: import_zod15.z.optional(
    import_zod15.z.union([import_zod15.z.string(), import_zod15.z.null()]),
  ),
  call_id: import_zod15.z
    .string()
    .min(1)
    .max(64)
    .describe(
  ...
  arguments: import_zod15.z
    .string()
    .describe('The function arguments as a JSON string.'),
  status: import_zod15.z.optional(
    import_zod15.z.union([
      import_zod15.z
        .lazy(() => functionCallStatusSchema)
        .and(import_zod15.z.any()),
      import_zod15.z.null(),
    ]),
  ),
})
...
var inputFileContentParamSchema = import_zod16.z
  .object({
    type: import_zod16.z
      .enum(['input_file'])
      .default('input_file')
      .describe('The type of the input item. Always `input_file`.'),
    filename: import_zod16.z.optional(
      import_zod16.z.union([import_zod16.z.string(), import_zod16.z.null()]),
    ),
    file_data: import_zod16.z.optional(
      import_zod16.z.union([import_zod16.z.string(), import_zod16.z.null()]),
    ),
    file_url: import_zod16.z.optional(
      import_zod16.z.union([import_zod16.z.string(), import_zod16.z.null()]),
    ),
  })
...
var inputImageContentParamAutoParamSchema = import_zod18.z
  .object({
    type: import_zod18.z
      .enum(['input_image'])
      .default('input_image')
      .describe('The type of the input item. Always `input_image`.'),
    image_url: import_zod18.z.optional(
      import_zod18.z.union([import_zod18.z.string(), import_zod18.z.null()]),
    ),
    detail: import_zod18.z.optional(
      import_zod18.z.union([
        import_zod18.z.lazy(() => imageDetailSchema).and(import_zod18.z.any()),
        import_zod18.z.null(),
      ]),
    ),
  })
...
var inputTextContentParamSchema = import_zod19.z
  .object({
    type: import_zod19.z
      .enum(['input_text'])
      .default('input_text')
...
var inputVideoContentSchema = import_zod20.z
  .object({
    type: import_zod20.z
      .enum(['input_video'])
      .describe('The type of the input content. Always `input_video`.'),
    video_url: import_zod20.z
      .string()
...
var functionCallOutputItemParamSchema = import_zod21.z
  .object({
    id: import_zod21.z.optional(
      import_zod21.z.union([import_zod21.z.string(), import_zod21.z.null()]),
    ),
    call_id: import_zod21.z
      .string()
      .min(1)
      .max(64)
      .describe(
    ...
    output: import_zod21.z
      .union([
        import_zod21.z.array(
          import_zod21.z
            .union([
              import_zod21.z
    ...
    status: import_zod21.z.optional(
      import_zod21.z.union([
        import_zod21.z
          .lazy(() => functionCallStatusSchema)
          .and(import_zod21.z.any()),
        import_zod21.z.null(),
      ]),
    ),
  })
...
var itemReferenceParamSchema = import_zod22.z
  .object({
    type: import_zod22.z.optional(
      import_zod22.z.union([
        import_zod22.z.enum(['item_reference']),
        import_zod22.z.null(),
      ]),
    ),
...
var reasoningSummaryContentParamSchema = import_zod23.z.object({
  ...
  text: import_zod23.z
    .string()
    .max(10485760)
    .describe('The reasoning summary text.'),
})

// src/gen/zod/reasoningItemParamSchema.ts
var import_zod24 = require('zod')
var reasoningItemParamSchema = import_zod24.z.object({
  id: import_zod24.z.optional(
    import_zod24.z.union([import_zod24.z.string(), import_zod24.z.null()]),
  ),
  type: import_zod24.z
    .enum(['reasoning'])
    .default('reasoning')
    .describe('The item type. Always `reasoning`.'),
  summary: import_zod24.z
    .array(import_zod24.z.lazy(() => reasoningSummaryContentParamSchema))
    .describe('Reasoning summary content associated with this item.'),
  content: import_zod24.z.optional(import_zod24.z.null()),
  encrypted_content: import_zod24.z.optional(
    import_zod24.z.union([import_zod24.z.string(), import_zod24.z.null()]),
  ),
})
...
var itemParamSchema = import_zod25.z.union([
  import_zod25.z
...
var metadataParamSchema = import_zod26.z
  .object({})
  .catchall(import_zod26.z.string().max(512))
  .describe(
...
var reasoningEffortEnumSchema = import_zod27.z.enum([
  'none',
  'low',
  'medium',
  'high',
...
var reasoningSummaryEnumSchema = import_zod28.z.enum([
  'concise',
  'detailed',
  'auto',
])
...
var reasoningParamSchema = import_zod29.z
  .object({
    effort: import_zod29.z.optional(
      import_zod29.z.union([
        import_zod29.z.lazy(() => reasoningEffortEnumSchema),
        import_zod29.z.null(),
      ]),
    ),
    summary: import_zod29.z.optional(
      import_zod29.z.union([
        import_zod29.z
          .lazy(() => reasoningSummaryEnumSchema)
          .and(import_zod29.z.any()),
        import_zod29.z.null(),
      ]),
    ),
  })
...
var functionToolParamSchema = import_zod31.z.object({
  name: import_zod31.z
    ...
    .max(64)
    .regex(/^[a-zA-Z0-9_-]+$/),
  description: import_zod31.z.optional(
    import_zod31.z.union([import_zod31.z.string(), import_zod31.z.null()]),
  ),
  parameters: import_zod31.z.optional(
    import_zod31.z.union([
      import_zod31.z.lazy(() => emptyModelParamSchema),
      import_zod31.z.null(),
    ]),
  ),
...
var responsesToolParamSchema = import_zod32.z
...
var serviceTierEnumSchema = import_zod33.z.enum([
  'auto',
  'default',
  'flex',
  'priority',
...
var streamOptionsParamSchema = import_zod34.z
  .object({
    include_obfuscation: import_zod34.z.optional(
      import_zod34.z
        .boolean()
        .describe(
...
var jsonSchemaResponseFormatParamSchema = import_zod35.z.object({
  ...
  description: import_zod35.z.optional(
    import_zod35.z
      .string()
      .describe(
  ...
  schema: import_zod35.z.optional(
    import_zod35.z
      .object({})
      .catchall(import_zod35.z.any())
      .describe(
        'The schema for the response format, described as a JSON Schema object.\n',
      ),
  ),
  strict: import_zod35.z.optional(
    import_zod35.z.union([import_zod35.z.boolean(), import_zod35.z.null()]),
  ),
})
...
var textFormatParamSchema = import_zod37.z.union([
  import_zod37.z.lazy(() => textResponseFormatSchema),
  import_zod37.z.lazy(() => jsonSchemaResponseFormatParamSchema),
])
...
var textParamSchema = import_zod39.z.object({
  format: import_zod39.z.optional(
    import_zod39.z
      .union([
        import_zod39.z.lazy(() => textFormatParamSchema),
        import_zod39.z.null(),
      ])
      .describe('The format configuration for text output.'),
  ),
  verbosity: import_zod39.z.optional(
    import_zod39.z.lazy(() => verbosityEnumSchema).and(import_zod39.z.any()),
  ),
})

// src/gen/zod/toolChoiceParamSchema.ts
var import_zod40 = require('zod')
var toolChoiceParamSchema = import_zod40.z
  .union([
    import_zod40.z.lazy(() => specificToolChoiceParamSchema),
    import_zod40.z.lazy(() => toolChoiceValueEnumSchema),
    import_zod40.z.lazy(() => allowedToolsParamSchema),
  ])
...
var createResponseBodySchema = import_zod42.z.object({
  model: import_zod42.z.optional(
    import_zod42.z.union([import_zod42.z.string(), import_zod42.z.null()]),
  ),
  input: import_zod42.z.optional(
    import_zod42.z.union([
      import_zod42.z.union([
        import_zod42.z.array(import_zod42.z.lazy(() => itemParamSchema)),
        import_zod42.z.string(),
      ]),
      import_zod42.z.null(),
    ]),
  ),
  previous_response_id: import_zod42.z.optional(
    import_zod42.z.union([import_zod42.z.string(), import_zod42.z.null()]),
  ),
  include: import_zod42.z.optional(
    import_zod42.z.array(import_zod42.z.lazy(() => includeEnumSchema)),
  ),
  tools: import_zod42.z.optional(
    import_zod42.z.union([
      import_zod42.z.array(import_zod42.z.lazy(() => responsesToolParamSchema)),
      import_zod42.z.null(),
    ]),
  ),
  tool_choice: import_zod42.z.optional(
    import_zod42.z.union([
      import_zod42.z
        .lazy(() => toolChoiceParamSchema)
        .and(import_zod42.z.any()),
      import_zod42.z.null(),
    ]),
  ),
  metadata: import_zod42.z.optional(
    import_zod42.z.union([
      import_zod42.z.lazy(() => metadataParamSchema).and(import_zod42.z.any()),
      import_zod42.z.null(),
    ]),
  ),
  text: import_zod42.z.optional(
    import_zod42.z.union([
      import_zod42.z.lazy(() => textParamSchema).and(import_zod42.z.any()),
      import_zod42.z.null(),
    ]),
  ),
  temperature: import_zod42.z.optional(
    import_zod42.z.union([import_zod42.z.number(), import_zod42.z.null()]),
  ),
  top_p: import_zod42.z.optional(
    import_zod42.z.union([import_zod42.z.number(), import_zod42.z.null()]),
  ),
  presence_penalty: import_zod42.z.optional(
    import_zod42.z.union([import_zod42.z.number(), import_zod42.z.null()]),
  ),
  frequency_penalty: import_zod42.z.optional(
    import_zod42.z.union([import_zod42.z.number(), import_zod42.z.null()]),
  ),
  parallel_tool_calls: import_zod42.z.optional(
    import_zod42.z.union([import_zod42.z.boolean(), import_zod42.z.null()]),
  ),
  stream: import_zod42.z.optional(
    import_zod42.z
      .boolean()
      .describe('Whether to stream response events as server-sent events.'),
  ),
  stream_options: import_zod42.z.optional(
    import_zod42.z.union([
      import_zod42.z
        .lazy(() => streamOptionsParamSchema)
        .and(import_zod42.z.any()),
      import_zod42.z.null(),
    ]),
  ),
  background: import_zod42.z.optional(
    import_zod42.z
      .boolean()
      .describe(
  ...
  max_output_tokens: import_zod42.z.optional(
    import_zod42.z.union([
      import_zod42.z.number().int(),
      import_zod42.z.null(),
    ]),
  ),
  max_tool_calls: import_zod42.z.optional(
    import_zod42.z.union([
      import_zod42.z.number().int(),
      import_zod42.z.null(),
    ]),
  ),
  reasoning: import_zod42.z.optional(
    import_zod42.z.union([
      import_zod42.z.lazy(() => reasoningParamSchema).and(import_zod42.z.any()),
      import_zod42.z.null(),
    ]),
  ),
  safety_identifier: import_zod42.z.optional(
    import_zod42.z.union([import_zod42.z.string(), import_zod42.z.null()]),
  ),
  prompt_cache_key: import_zod42.z.optional(
    import_zod42.z.union([import_zod42.z.string(), import_zod42.z.null()]),
  ),
  truncation: import_zod42.z.optional(
    import_zod42.z.lazy(() => truncationEnumSchema).and(import_zod42.z.any()),
  ),
  instructions: import_zod42.z.optional(
    import_zod42.z.union([import_zod42.z.string(), import_zod42.z.null()]),
  ),
  store: import_zod42.z.optional(
    import_zod42.z
      .boolean()
      .describe('Whether to store the response so it can be retrieved later.'),
  ),
  service_tier: import_zod42.z.optional(
    import_zod42.z.lazy(() => serviceTierEnumSchema).and(import_zod42.z.any()),
  ),
  top_logprobs: import_zod42.z.optional(
    import_zod42.z.union([
      import_zod42.z.number().int(),
      import_zod42.z.null(),
    ]),
...
var incompleteDetailsSchema = import_zod44.z
  .object({
    reason: import_zod44.z
      .string()
...
var functionCallOutputStatusEnumSchema = import_zod45.z
...
var inputFileContentSchema = import_zod46.z
  .object({
    type: import_zod46.z
      .enum(['input_file'])
      .default('input_file')
      .describe('The type of the input item. Always `input_file`.'),
    filename: import_zod46.z.optional(
      import_zod46.z
        .string()
        .describe('The name of the file to be sent to the model.'),
    ),
    file_url: import_zod46.z.optional(
      import_zod46.z
        .string()
...
var inputImageContentSchema = import_zod47.z
  .object({
    type: import_zod47.z
      .enum(['input_image'])
      .default('input_image')
      .describe('The type of the input item. Always `input_image`.'),
    image_url: import_zod47.z.union([
      import_zod47.z.string(),
      import_zod47.z.null(),
    ]),
    detail: import_zod47.z
      .lazy(() => imageDetailSchema)
      .and(import_zod47.z.any()),
  })
  .describe(
    'An image input to the model. Learn about [image inputs](/docs/guides/vision).',
  )
...
var inputTextContentSchema = import_zod48.z
  .object({
    type: import_zod48.z
      .enum(['input_text'])
      .default('input_text')
...
var functionCallOutputSchema = import_zod49.z
  .object({
    type: import_zod49.z
      .enum(['function_call_output'])
      .default('function_call_output')
    ...
    call_id: import_zod49.z
      .string()
      .describe(
        'The unique ID of the function tool call generated by the model.',
      ),
    output: import_zod49.z.union([
      ...
      import_zod49.z.string(),
    ]),
    status: import_zod49.z
      .lazy(() => functionCallOutputStatusEnumSchema)
      .and(import_zod49.z.any()),
  })
  .describe('A function tool call output that was returned by the tool.')

// src/gen/zod/functionCallSchema.ts
var import_zod50 = require('zod')
var functionCallSchema = import_zod50.z
  .object({
    type: import_zod50.z
      .enum(['function_call'])
      .default('function_call')
...
var messageStatusSchema = import_zod52.z.enum([
  'in_progress',
  'completed',
  'incomplete',
])
...
var topLogProbSchema = import_zod53.z
  .object({
...
var outputTextContentSchema = import_zod55.z
  .object({
    type: import_zod55.z
      .enum(['output_text'])
      .default('output_text')
...
var reasoningTextContentSchema = import_zod56.z
  .object({
    type: import_zod56.z
      .enum(['reasoning_text'])
...
var refusalContentSchema = import_zod57.z
  .object({
    type: import_zod57.z
      .enum(['refusal'])
      .default('refusal')
      .describe('The type of the refusal. Always `refusal`.'),
    refusal: import_zod57.z
      .string()
...
var summaryTextContentSchema = import_zod58.z
  .object({
    type: import_zod58.z
      .enum(['summary_text'])
      .default('summary_text')
...
var textContentSchema = import_zod59.z
  .object({
...
var messageSchema = import_zod60.z
  .object({
    type: import_zod60.z
      .enum(['message'])
      .default('message')
    ...
    status: import_zod60.z
      .lazy(() => messageStatusSchema)
      .and(import_zod60.z.any()),
    role: import_zod60.z
      .lazy(() => messageRoleSchema)
      .and(import_zod60.z.any()),
    content: import_zod60.z
      .array(
        import_zod60.z
          .union([
            import_zod60.z
...
var reasoningBodySchema = import_zod61.z
  .object({
    type: import_zod61.z
      .enum(['reasoning'])
      .default('reasoning')
    ...
    id: import_zod61.z
      .string()
      .describe('The unique ID of the reasoning item.'),
    content: import_zod61.z.optional(
      import_zod61.z
        .array(
          import_zod61.z
            .union([
    ...
    encrypted_content: import_zod61.z.optional(
      import_zod61.z
        .string()
...
var itemFieldSchema = import_zod62.z
  .union([
    import_zod62.z
      .lazy(() => messageSchema)
      .and(
...
var reasoningSchema = import_zod63.z
  .object({
    effort: import_zod63.z.union([
      import_zod63.z.lazy(() => reasoningEffortEnumSchema),
      import_zod63.z.null(),
    ]),
    summary: import_zod63.z.union([
      import_zod63.z
        .lazy(() => reasoningSummaryEnumSchema)
        .and(import_zod63.z.any()),
      import_zod63.z.null(),
    ]),
  })
  .describe(
...
var jsonSchemaResponseFormatSchema = import_zod65.z.object({
  ...
  description: import_zod65.z.union([
    import_zod65.z.string(),
    import_zod65.z.null(),
  ]),
...
var textFieldSchema = import_zod66.z.object({
  format: import_zod66.z.union([
    import_zod66.z.lazy(() => textResponseFormatSchema),
    import_zod66.z.lazy(() => jsonObjectResponseFormatSchema),
    import_zod66.z.lazy(() => jsonSchemaResponseFormatSchema),
  ]),
  verbosity: import_zod66.z.optional(
    import_zod66.z.lazy(() => verbosityEnumSchema),
  ),
})

// src/gen/zod/functionToolSchema.ts
var import_zod67 = require('zod')
var functionToolSchema = import_zod67.z
  .object({
    type: import_zod67.z
      .enum(['function'])
      .default('function')
    ...
    description: import_zod67.z.union([
      import_zod67.z.string(),
      import_zod67.z.null(),
    ]),
    parameters: import_zod67.z.union([
      import_zod67.z.object({}).catchall(import_zod67.z.any()),
      import_zod67.z.null(),
    ]),
    strict: import_zod67.z.union([
      import_zod67.z.boolean(),
      import_zod67.z.null(),
    ]),
  })
  .describe(
...
var inputTokensDetailsSchema = import_zod69.z
  .object({
    cached_tokens: import_zod69.z
      .number()
      .int()
...
var outputTokensDetailsSchema = import_zod70.z
  .object({
    reasoning_tokens: import_zod70.z
      .number()
      .int()
      .describe(
...
var usageSchema = import_zod71.z
  .object({
    input_tokens: import_zod71.z
      .number()
      .int()
      .describe(
        'The number of input tokens that were used to generate the response.',
      ),
    output_tokens: import_zod71.z
      .number()
      .int()
      .describe(
        'The number of output tokens that were generated by the model.',
      ),
    total_tokens: import_zod71.z
      .number()
      .int()
      .describe('The total number of tokens that were used.'),
    input_tokens_details: import_zod71.z
      .lazy(() => inputTokensDetailsSchema)
      .and(import_zod71.z.any()),
    output_tokens_details: import_zod71.z
...
var responseResourceSchema = import_zod72.z
  .object({
    id: import_zod72.z
      .string()
      .describe('The unique ID of the response that was created.'),
    object: import_zod72.z
      .enum(['response'])
      .default('response')
      .describe('The object type, which was always `response`.'),
    created_at: import_zod72.z
      .number()
      .int()
      .describe(
        'The Unix timestamp (in seconds) for when the response was created.',
      ),
    completed_at: import_zod72.z.union([
      import_zod72.z.number().int(),
      import_zod72.z.null(),
    ]),
    status: import_zod72.z
      .string()
      .describe('The status that was set for the response.'),
    incomplete_details: import_zod72.z.union([
      import_zod72.z
        .lazy(() => incompleteDetailsSchema)
        .and(import_zod72.z.any()),
      import_zod72.z.null(),
    ]),
    model: import_zod72.z
      .string()
      .describe('The model that generated this response.'),
    previous_response_id: import_zod72.z.union([
      import_zod72.z.string(),
      import_zod72.z.null(),
    ]),
    instructions: import_zod72.z.union([
      import_zod72.z.string(),
      import_zod72.z.null(),
    ]),
    output: import_zod72.z
      .array(
        import_zod72.z
    ...
    error: import_zod72.z.union([
      import_zod72.z.lazy(() => errorSchema).and(import_zod72.z.any()),
      import_zod72.z.null(),
    ]),
    tools: import_zod72.z
      .array(
        import_zod72.z
          .lazy(() => toolSchema)
          .describe('A tool that can be used to generate a response.'),
    ...
    tool_choice: import_zod72.z.union([
      import_zod72.z.lazy(() => functionToolChoiceSchema),
      import_zod72.z.lazy(() => toolChoiceValueEnumSchema),
      import_zod72.z.lazy(() => allowedToolChoiceSchema),
    ]),
    truncation: import_zod72.z
      .lazy(() => truncationEnumSchema)
      .and(import_zod72.z.any()),
    parallel_tool_calls: import_zod72.z
      .boolean()
      .describe(
...
var createresponse200Schema = import_zod73.z
  .lazy(() => responseResourceSchema)
  .describe(
    'The complete response object that was returned by the Responses API.',
  )
var createresponseMutationRequestSchema = import_zod73.z.lazy(
  () => createResponseBodySchema,
)
var createresponseMutationResponseSchema = import_zod73.z.lazy(
...
var developerMessageItemParamSchema = import_zod75.z.object({
  id: import_zod75.z.optional(
    import_zod75.z.union([import_zod75.z.string(), import_zod75.z.null()]),
  ),
  type: import_zod75.z
    .enum(['message'])
    .default('message')
  ...
  content: import_zod75.z
    .union([
      import_zod75.z.array(
        import_zod75.z
          .lazy(() => inputTextContentParamSchema)
          .and(
            import_zod75.z.object({
              type: import_zod75.z.literal('input_text'),
            }),
          ),
      ),
      import_zod75.z.string(),
    ])
    .describe('The message content, as an array of content parts.'),
  status: import_zod75.z.optional(
    import_zod75.z.union([import_zod75.z.string(), import_zod75.z.null()]),
  ),
})
...
var errorPayloadSchema = import_zod76.z
  .object({
    type: import_zod76.z.string().describe('The error type that was emitted.'),
    code: import_zod76.z.union([
      import_zod76.z.string(),
      import_zod76.z.null(),
    ]),
    message: import_zod76.z
      .string()
      .describe('The human-readable error message that was emitted.'),
    param: import_zod76.z.union([
      import_zod76.z.string(),
      import_zod76.z.null(),
    ]),
    headers: import_zod76.z.optional(
      import_zod76.z
        .object({})
        .catchall(
          import_zod76.z
            .string()
            .describe('The header value that was emitted.'),
        )
        .describe(
...
var errorStreamingEventSchema = import_zod77.z
  .object({
    type: import_zod77.z
      .enum(['error'])
      .default('error')
      .describe('The type of the event, always `error`.'),
    sequence_number: import_zod77.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    error: import_zod77.z
      .lazy(() => errorPayloadSchema)
      .and(import_zod77.z.any()),
  })
...
var functionCallItemStatusSchema = import_zod78.z.enum([
  'in_progress',
  'completed',
  'incomplete',
])
...
var responseCompletedStreamingEventSchema = import_zod79.z
  .object({
    type: import_zod79.z
      .enum(['response.completed'])
      .default('response.completed')
      .describe('The type of the event, always `response.completed`.'),
    sequence_number: import_zod79.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    response: import_zod79.z
      .lazy(() => responseResourceSchema)
      .and(import_zod79.z.any()),
  })
...
var responseContentPartAddedStreamingEventSchema = import_zod80.z
  .object({
    type: import_zod80.z
      .enum(['response.content_part.added'])
      .default('response.content_part.added')
      .describe('The type of the event, always `response.content_part.added`.'),
    sequence_number: import_zod80.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod80.z
      .string()
      .describe('The ID of the item that was updated.'),
    output_index: import_zod80.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    content_index: import_zod80.z
      .number()
      .int()
...
var responseContentPartDoneStreamingEventSchema = import_zod81.z
  .object({
    type: import_zod81.z
    ...
    sequence_number: import_zod81.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod81.z
      .string()
      .describe('The ID of the item that was updated.'),
    output_index: import_zod81.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    content_index: import_zod81.z
      .number()
      .int()
...
var responseCreatedStreamingEventSchema = import_zod82.z
  .object({
    type: import_zod82.z
      .enum(['response.created'])
      .default('response.created')
      .describe('The type of the event, always `response.created`.'),
    sequence_number: import_zod82.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    response: import_zod82.z
      .lazy(() => responseResourceSchema)
      .and(import_zod82.z.any()),
  })
...
var responseFailedStreamingEventSchema = import_zod83.z
  .object({
    type: import_zod83.z
      .enum(['response.failed'])
      .default('response.failed')
      .describe('The type of the event, always `response.failed`.'),
    sequence_number: import_zod83.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    response: import_zod83.z
      .lazy(() => responseResourceSchema)
      .and(import_zod83.z.any()),
  })
...
var responseFunctionCallArgumentsDeltaStreamingEventSchema = import_zod84.z
  .object({
    type: import_zod84.z
    ...
    sequence_number: import_zod84.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod84.z
      .string()
      .describe('The ID of the tool call item that was updated.'),
    output_index: import_zod84.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    delta: import_zod84.z
      .string()
      .describe('The arguments delta that was appended.'),
    obfuscation: import_zod84.z.optional(
      import_zod84.z
        .string()
        .describe(
...
var responseFunctionCallArgumentsDoneStreamingEventSchema = import_zod85.z
  .object({
    type: import_zod85.z
    ...
    sequence_number: import_zod85.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod85.z
      .string()
      .describe('The ID of the tool call item that was updated.'),
    output_index: import_zod85.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    arguments: import_zod85.z
      .string()
...
var responseIncompleteStreamingEventSchema = import_zod86.z
  .object({
    type: import_zod86.z
      .enum(['response.incomplete'])
      .default('response.incomplete')
      .describe('The type of the event, always `response.incomplete`.'),
    sequence_number: import_zod86.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    response: import_zod86.z
      .lazy(() => responseResourceSchema)
      .and(import_zod86.z.any()),
  })
...
var responseInProgressStreamingEventSchema = import_zod87.z
  .object({
    type: import_zod87.z
      .enum(['response.in_progress'])
      .default('response.in_progress')
      .describe('The type of the event, always `response.in_progress`.'),
    sequence_number: import_zod87.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    response: import_zod87.z
      .lazy(() => responseResourceSchema)
      .and(import_zod87.z.any()),
  })
...
var responseOutputItemAddedStreamingEventSchema = import_zod88.z
  .object({
    type: import_zod88.z
    ...
    sequence_number: import_zod88.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    output_index: import_zod88.z
      .number()
      .int()
      .describe('The index of the output item that was added.'),
    item: import_zod88.z.union([
      import_zod88.z.lazy(() => itemFieldSchema).and(import_zod88.z.any()),
      import_zod88.z.null(),
    ]),
  })
  .describe(
...
var responseOutputItemDoneStreamingEventSchema = import_zod89.z
  .object({
    type: import_zod89.z
    ...
    sequence_number: import_zod89.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    output_index: import_zod89.z
      .number()
      .int()
      .describe('The index of the output item that was completed.'),
    item: import_zod89.z.union([
      import_zod89.z.lazy(() => itemFieldSchema).and(import_zod89.z.any()),
      import_zod89.z.null(),
    ]),
  })
...
var responseOutputTextAnnotationAddedStreamingEventSchema = import_zod90.z
  .object({
    type: import_zod90.z
    ...
    sequence_number: import_zod90.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod90.z
      .string()
      .describe('The ID of the item that was updated.'),
    output_index: import_zod90.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    content_index: import_zod90.z
      .number()
      .int()
      .describe('The index of the output text content that was updated.'),
    annotation_index: import_zod90.z
      .number()
      .int()
      .describe('The index of the annotation that was added.'),
    annotation: import_zod90.z.union([
      import_zod90.z.lazy(() => annotationSchema).and(import_zod90.z.any()),
      import_zod90.z.null(),
    ]),
  })
  .describe(
...
var responseOutputTextDeltaStreamingEventSchema = import_zod91.z
  .object({
    type: import_zod91.z
    ...
    sequence_number: import_zod91.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod91.z
      .string()
      .describe('The ID of the item that was updated.'),
    output_index: import_zod91.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    content_index: import_zod91.z
      .number()
      .int()
      .describe('The index of the content part that was updated.'),
    delta: import_zod91.z
      .string()
      .describe('The text delta that was appended.'),
    logprobs: import_zod91.z
      .array(
        import_zod91.z
          .lazy(() => logProbSchema)
          .describe('The log probability of a token.'),
    ...
    obfuscation: import_zod91.z.optional(
      import_zod91.z
        .string()
        .describe(
          'An obfuscation string that was added to pad the event payload.',
...
var responseOutputTextDoneStreamingEventSchema = import_zod92.z
  .object({
    type: import_zod92.z
    ...
    sequence_number: import_zod92.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod92.z
      .string()
      .describe('The ID of the item that was updated.'),
    output_index: import_zod92.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    content_index: import_zod92.z
      .number()
      .int()
      .describe('The index of the content part that was completed.'),
    text: import_zod92.z.string().describe('The final text that was emitted.'),
    logprobs: import_zod92.z
      .array(
        import_zod92.z
          .lazy(() => logProbSchema)
          .describe('The log probability of a token.'),
...
var responseQueuedStreamingEventSchema = import_zod93.z
  .object({
    type: import_zod93.z
      .enum(['response.queued'])
      .default('response.queued')
      .describe('The type of the event, always `response.queued`.'),
    sequence_number: import_zod93.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    response: import_zod93.z
      .lazy(() => responseResourceSchema)
      .and(import_zod93.z.any()),
  })
...
var responseReasoningDeltaStreamingEventSchema = import_zod94.z
  .object({
    type: import_zod94.z
    ...
    sequence_number: import_zod94.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod94.z
      .string()
      .describe('The ID of the item that was updated.'),
    output_index: import_zod94.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    content_index: import_zod94.z
      .number()
      .int()
      .describe('The index of the reasoning content that was updated.'),
    delta: import_zod94.z
      .string()
      .describe('The reasoning text delta that was appended.'),
    obfuscation: import_zod94.z.optional(
      import_zod94.z
        .string()
        .describe(
          'An obfuscation string that was added to pad the event payload.',
...
var responseReasoningDoneStreamingEventSchema = import_zod95.z
  .object({
    type: import_zod95.z
      .enum(['response.reasoning.done'])
      .default('response.reasoning.done')
      .describe('The type of the event, always `response.reasoning.done`.'),
    sequence_number: import_zod95.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod95.z
      .string()
      .describe('The ID of the item that was updated.'),
    output_index: import_zod95.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    content_index: import_zod95.z
      .number()
      .int()
...
var responseReasoningSummaryDeltaStreamingEventSchema = import_zod96.z
  .object({
    type: import_zod96.z
    ...
    sequence_number: import_zod96.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod96.z
      .string()
      .describe('The ID of the item that was updated.'),
    output_index: import_zod96.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    summary_index: import_zod96.z
      .number()
      .int()
      .describe('The index of the summary content that was updated.'),
    delta: import_zod96.z
      .string()
      .describe('The summary text delta that was appended.'),
    obfuscation: import_zod96.z.optional(
      import_zod96.z
        .string()
        .describe(
          'An obfuscation string that was added to pad the event payload.',
...
var responseReasoningSummaryDoneStreamingEventSchema = import_zod97.z
  .object({
    type: import_zod97.z
    ...
    sequence_number: import_zod97.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod97.z
      .string()
      .describe('The ID of the item that was updated.'),
    output_index: import_zod97.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    summary_index: import_zod97.z
      .number()
      .int()
      .describe('The index of the summary content that was completed.'),
    text: import_zod97.z
      .string()
      .describe('The final summary text that was emitted.'),
  })
  .describe(
...
var responseReasoningSummaryPartAddedStreamingEventSchema = import_zod98.z
  .object({
    type: import_zod98.z
    ...
    sequence_number: import_zod98.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod98.z
      .string()
      .describe('The ID of the item that was updated.'),
    output_index: import_zod98.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    summary_index: import_zod98.z
      .number()
      .int()
...
var responseReasoningSummaryPartDoneStreamingEventSchema = import_zod99.z
  .object({
    type: import_zod99.z
    ...
    sequence_number: import_zod99.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod99.z
      .string()
      .describe('The ID of the item that was updated.'),
    output_index: import_zod99.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    summary_index: import_zod99.z
      .number()
      .int()
...
var responseRefusalDeltaStreamingEventSchema = import_zod100.z
  .object({
    type: import_zod100.z
      .enum(['response.refusal.delta'])
      .default('response.refusal.delta')
      .describe('The type of the event, always `response.refusal.delta`.'),
    sequence_number: import_zod100.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod100.z
      .string()
      .describe('The ID of the item that was updated.'),
    output_index: import_zod100.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    content_index: import_zod100.z
      .number()
      .int()
      .describe('The index of the refusal content that was updated.'),
    delta: import_zod100.z
      .string()
...
var responseRefusalDoneStreamingEventSchema = import_zod101.z
  .object({
    type: import_zod101.z
      .enum(['response.refusal.done'])
      .default('response.refusal.done')
      .describe('The type of the event, always `response.refusal.done`.'),
    sequence_number: import_zod101.z
      .number()
      .int()
      .describe('The sequence number of the event that was emitted.'),
    item_id: import_zod101.z
      .string()
      .describe('The ID of the item that was updated.'),
    output_index: import_zod101.z
      .number()
      .int()
      .describe('The index of the output item that was updated.'),
    content_index: import_zod101.z
      .number()
      .int()
      .describe('The index of the refusal content that was completed.'),
    refusal: import_zod101.z
      .string()
      .describe('The final refusal text that was emitted.'),
  })
...
var systemMessageItemParamSchema = import_zod102.z.object({
  id: import_zod102.z.optional(
    import_zod102.z.union([import_zod102.z.string(), import_zod102.z.null()]),
  ),
  type: import_zod102.z
    .enum(['message'])
    .default('message')
    .describe('The item type. Always `message`.'),
  role: import_zod102.z
    .enum(['system'])
    .default('system')
    .describe('The message role. Always `system`.'),
  content: import_zod102.z
    .union([
      import_zod102.z.array(
        import_zod102.z
          .lazy(() => inputTextContentParamSchema)
          .and(
    ...
    .describe('The message content, as an array of content parts.'),
  status: import_zod102.z.optional(
    import_zod102.z.union([import_zod102.z.string(), import_zod102.z.null()]),
  ),
})
...
var userMessageItemParamSchema = import_zod103.z.object({
  id: import_zod103.z.optional(
    import_zod103.z.union([import_zod103.z.string(), import_zod103.z.null()]),
  ),
  type: import_zod103.z
    .enum(['message'])
    .default('message')
    .describe('The item type. Always `message`.'),
  role: import_zod103.z
    .enum(['user'])
    .default('user')
    .describe('The message role. Always `user`.'),
  content: import_zod103.z
    .union([
      import_zod103.z.array(
        import_zod103.z
          .union([
            import_zod103.z
              .lazy(() => inputTextContentParamSchema)
              .and(
                import_zod103.z.object({
      ...
      import_zod103.z.string(),
    ])
    .describe('The message content, as an array of content parts.'),
  status: import_zod103.z.optional(
    import_zod103.z.union([import_zod103.z.string(), import_zod103.z.null()]),
  ),
})
