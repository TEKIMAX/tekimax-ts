...
import { n as jsx } from "./jsx-runtime-CpElaHq6.js";
	...
	module.exports = function($$$config) {
		...
		function updateSuspenseComponent(current, workInProgress, renderLanes) {
			...
			if (null !== prevState && (nextPrimaryChildren = prevState.dehydrated, null !== nextPrimaryChildren)) {
				...
				else if (pushPrimaryTreeSuspenseHandler(workInProgress), isSuspenseInstanceFallback(nextPrimaryChildren)) JSCompiler_temp = getSuspenseInstanceFallbackErrorDetails(nextPrimaryChildren).digest, nextProps = Error(formatProdErrorMessage(419)), nextProps.stack = "", nextProps.digest = JSCompiler_temp, queueHydrationError({
					value: nextProps,
					source: null,
					stack: null
			...
			switch (workInProgress.tag) {
				...
				case 3:
					a: {
						...
						if (supportsHydration && $$typeof.isDehydrated) if ($$typeof = {
							element: nextProps,
							isDehydrated: !1,
		...
		function appendAllChildren(parent, workInProgress, needsVisibilityToggle, isHidden) {
			if (supportsMutation) for (needsVisibilityToggle = workInProgress.child; null !== needsVisibilityToggle;) {
				...
				} else if (6 === node$85.tag) instance = node$85.stateNode, needsVisibilityToggle && isHidden && (instance = cloneHiddenTextInstance(instance, node$85.memoizedProps)), appendInitialChild(parent, instance);
				else if (4 !== node$85.tag) {
					if (22 === node$85.tag && null !== node$85.memoizedState) instance = node$85.child, null !== instance && (instance.return = node$85), appendAllChildren(parent, node$85, !0, !0);
		...
		function completeWork(current, workInProgress, renderLanes) {
			...
			switch (workInProgress.tag) {
				...
				case 13:
					...
					bubbleProperties(workInProgress);
					return null;
				case 4: return popHostContainer(), updateHostContainer(current, workInProgress), null === current && preparePortalMount(workInProgress.stateNode.containerInfo), bubbleProperties(workInProgress), null;
					...
					if (supportsMutation) {
						...
						switch (hostParentFiber.tag) {
							...
							case 5:
								...
								insertOrAppendPlacementNode(finishedWork, getHostSibling(finishedWork), parent$125);
								break;
							case 3:
							case 4:
								var parent$127 = hostParentFiber.stateNode.containerInfo;
								insertOrAppendPlacementNodeIntoContainer(finishedWork, getHostSibling(finishedWork), parent$127);
								break;
		...
		function createFiberFromTypeAndProps(type, key, pendingProps, owner, mode, lanes) {
			...
			if ("function" === typeof type) shouldConstruct(type) && (fiberTag = 1);
				...
				case REACT_ACTIVITY_TYPE: return type = createFiber(31, pendingProps, key, mode), type.elementType = REACT_ACTIVITY_TYPE, type.lanes = lanes, type;
				case REACT_FRAGMENT_TYPE: return createFiberFromFragment(pendingProps.children, mode, lanes, key);
				case REACT_STRICT_MODE_TYPE:
					fiberTag = 8;
					mode |= 24;
					break;
				case REACT_PROFILER_TYPE: return type = createFiber(12, pendingProps, key, mode | 2), type.elementType = REACT_PROFILER_TYPE, type.lanes = lanes, type;
				case REACT_SUSPENSE_TYPE: return type = createFiber(13, pendingProps, key, mode), type.elementType = REACT_SUSPENSE_TYPE, type.lanes = lanes, type;
		...
		exports$2.attemptHydrationAtCurrentPriority = function(fiber) {
			if (13 === fiber.tag || 31 === fiber.tag) {
				var lane = requestUpdateLane();
		...
		exports$2.attemptSynchronousHydration = function(fiber) {
			switch (fiber.tag) {
				case 3:
		...
		exports$2.batchedUpdates = function(fn, a) {
			return fn(a);
		};
		exports$2.createComponentSelector = function(component) {
			return {
				$$typeof: COMPONENT_TYPE,
				value: component
			};
		};
		exports$2.createContainer = function(containerInfo, tag, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onUncaughtError, onCaughtError, onRecoverableError, onDefaultTransitionIndicator) {
		...
		exports$2.createHasPseudoClassSelector = function(selectors) {
			return {
				$$typeof: HAS_PSEUDO_CLASS_TYPE,
				value: selectors
			};
		};
		exports$2.createHydrationContainer = function(initialChildren, callback, containerInfo, tag, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onUncaughtError, onCaughtError, onRecoverableError, onDefaultTransitionIndicator, transitionCallbacks, formState) {
		...
		exports$2.createPortal = function(children, containerInfo, implementation) {
		...
		exports$2.createRoleSelector = function(role) {
			return {
				$$typeof: ROLE_TYPE,
				value: role
			};
		};
		exports$2.createTestNameSelector = function(id) {
			return {
				$$typeof: TEST_NAME_TYPE,
				value: id
			};
		};
		exports$2.createTextSelector = function(text) {
			return {
				$$typeof: TEXT_TYPE,
				value: text
			};
		};
		exports$2.defaultOnCaughtError = function(error) {
			console.error(error);
		};
		exports$2.defaultOnRecoverableError = function(error) {
			reportGlobalError(error);
		};
		exports$2.defaultOnUncaughtError = function(error) {
			reportGlobalError(error);
		};
		...
		exports$2.findAllNodes = findAllNodes;
		exports$2.findBoundingRects = function(hostRoot, selectors) {
			if (!supportsTestSelectors) throw Error(formatProdErrorMessage(363));
		...
		exports$2.findHostInstance = findHostInstance;
		exports$2.findHostInstanceWithNoPortals = function(fiber) {
			fiber = findCurrentFiberUsingSlowPath(fiber);
			fiber = null !== fiber ? findCurrentHostFiberWithNoPortalsImpl(fiber) : null;
			return null === fiber ? null : getPublicInstance(fiber.stateNode);
		};
		exports$2.findHostInstanceWithWarning = function(component) {
			return findHostInstance(component);
		};
		exports$2.flushPassiveEffects = flushPendingEffects;
		...
		exports$2.flushSyncWork = flushSyncWork;
		exports$2.focusWithin = function(hostRoot, selectors) {
			if (!supportsTestSelectors) throw Error(formatProdErrorMessage(363));
			hostRoot = findFiberRootForHostRoot(hostRoot);
		...
		exports$2.getPublicRootInstance = function(container) {
		...
		exports$2.injectIntoDevTools = function() {
			var internals = {
				bundleType: 0,
		...
		exports$2.isAlreadyRendering = function() {
			return 0 !== (executionContext & 6);
		};
		exports$2.observeVisibleRects = function(hostRoot, selectors, callback, options) {
			if (!supportsTestSelectors) throw Error(formatProdErrorMessage(363));
		...
		exports$2.shouldError = function() {
			return null;
		};
		exports$2.shouldSuspend = function() {
			return !1;
		};
		exports$2.startHostTransition = function(formFiber, pendingState, action, formData) {
		...
		exports$2.updateContainerSync = function(element, container, parentComponent, callback) {
...
*/
const Renderer = (0, import_react_reconciler.default)({
	getRootHostContext: () => ({
		type: "kubb-root",
		isFile: false,
		isSource: false
...
//#endregion
export { _classPrivateFieldInitSpec as a, _classPrivateFieldGet2 as i, Runtime as n, Renderer as o, _classPrivateFieldSet2 as r, Root as s, reactPlugin as t };