const require_getRelativePath = require('./getRelativePath-d_IC-HuZ.cjs');
const require_Root = require('./Root-x_Ojfys2.cjs');
const require_typescriptParser = require('./typescriptParser-qas7awdJ.cjs');
