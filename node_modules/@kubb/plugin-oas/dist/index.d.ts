 ...
 */
type SchemaTreeWithKeyword<K$1 extends keyof SchemaKeywordMapper> = Omit<SchemaTree, 'current'> & {
  current: SchemaKeywordMapper[K$1];
};
/**
 ...
 */
type KeywordHandler<TOutput, TOptions, K$1 extends keyof SchemaKeywordMapper = keyof SchemaKeywordMapper> = (this: HandlerContext<TOutput, TOptions>, tree: SchemaTreeWithKeyword<K$1>, options: TOptions) => TOutput | null | undefined;
/**
 ...
 * ```
 */
declare function findSchemaKeyword<K$1 extends keyof SchemaKeywordMapper>(siblings: Schema[], keyword: K$1): SchemaKeywordMapper[K$1] | undefined;
//#endregion
...
declare function buildOperations<TOptions extends PluginFactoryOptions>(operations: Array<Operation>, {
  config,
  fabric,
  plugin,
  generator,
...
declare function buildOperation<TOptions extends PluginFactoryOptions>(operation: Operation, {
  config,
  fabric,
  plugin,
  generator,
