...
import { i as OperationSchemas, n as PluginClient, o as Operation } from "./types-Cvppe_Zq.cjs";
...
declare function Operations({
  name,
  operations
}: OperationsProps): FabricReactNode;
//#endregion
//#region src/components/StaticClassClient.d.ts
type Props$1 = {
  name: string;
  isExportable?: boolean;
  isIndexable?: boolean;
...
declare function StaticClassClient({
  name,
  isExportable,
  isIndexable,
  operations,
...
declare namespace StaticClassClient {
  var getParams: ({
    paramsType,
    paramsCasing,
    pathParamsType,
