...
type RawUniversalConfig, type RawUniversalApiConfig, type ResolvedConfig, type ResolvedApiConfig, type Plugin, type RuleConfig, type RuleSeverity, type IgnoreConfig, } from './config/index.js';
...
export { unescapePointerFragment, isRef, isAbsoluteUrl, getDir, resolvePath, escapePointerFragment, type Location, } from './ref-utils.js';
...
export { lint, lint as validate, lintDocument, lintFromString, lintConfig, lintEntityFile, } from './lint.js';
