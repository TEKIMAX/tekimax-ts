...
import type { BuiltInOAS2RuleId, BuiltInOAS3RuleId, BuiltInAsync2RuleId, BuiltInAsync3RuleId, BuiltInArazzo1RuleId, BuiltInOverlay1RuleId, BuiltInOpenRpc1RuleId, BuiltInCommonRuleId } from '../types/redocly-yaml.js';
...
export type RawGovernanceConfig<T extends 'built-in' | undefined = undefined> = {
    ...
    oas3_0Rules?: RuleMap<Exclude<BuiltInOAS3RuleId, 'spec-no-invalid-tag-parents' | 'spec-no-invalid-encoding-combinations' | 'spec-discriminator-defaultMapping'>, RuleConfig, T>;
    oas3_1Rules?: RuleMap<Exclude<BuiltInOAS3RuleId, 'nullable-type-sibling' | 'spec-no-invalid-tag-parents' | 'spec-no-invalid-encoding-combinations' | 'spec-discriminator-defaultMapping'>, RuleConfig, T>;
