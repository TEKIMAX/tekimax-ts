...
4. **`ProvisionPlugin`** (API Gateway): Endpoint-agnostic REST client with deployment-scoped auth, rate limiting, and namespace factory. See the [full ProvisionPlugin guide](/docs/guides/provision-plugin).
